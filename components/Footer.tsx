...
const SOCIALS = [
  { key: "tiktok", href: "https://www.tiktok.com/@toolcan.events", label: "TikTok", Icon: TikTokIcon },
  { key: "snap", href: "https://www.snapchat.com/add/toolcan.events", label: "Snapchat", Icon: SnapchatIcon },
  { key: "instagram", href: "https://www.instagram.com/toolcan.events", label: "Instagram", Icon: InstagramIcon },
  { key: "x", href: "https://x.com/toolcan_events", label: "X", Icon: XIcon },
]
...
const PAYMENTS: Array<{ key: string; label: string; src?: string; generic?: "bank" | "cod" }> = [
  ...
  { key: "amex", label: "American Express", src: "/payments/amex.svg" },
  { key: "tabby", label: "Tabby", src: "/payments/tabby.svg" },
  { key: "tamara", label: "Tamara", src: "/payments/tamara.svg" },
  { key: "bank", label: "bank", generic: "bank" },
  { key: "cod", label: "cod", generic: "cod" },
]
...
export function Footer({ dict, lang }: FooterProps) {
  return (
    <footer>
      ...
      {/* Payments row */}
      <div className="f-pay">
        <span className="f-pay-label">{dict.payLabel}</span>
        <div className="f-pay-chips">
          {PAYMENTS.map((p) =>
            p.generic ? (
              <TextBadge key={p.key} icon={p.generic === "bank" ? <BankIcon size={15} /> : <CodIcon size={15} />} label={dict.payGeneric[p.generic]} />
            ) : (
