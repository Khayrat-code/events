...
const ar = {
  ...
  hero: {
    ...
    words: ["نحول", "مناسبتك", "إلى", "حكاية", "تروى"],
    lead:
      "من أول وردة في الممر إلى آخر إضاءة في القاعة: تنسيق ورد، كوش، أعراس، تخرج، أعياد ميلاد وولائم — بتفاصيل فنية تليق بذوقك.",
    cta: "ابدأ حكايتك",
    stats: [
      { label: "مناسبة منسقة" },
      { label: "تخصصات تنسيق" },
  ...
  about: {
    ...
    sub:
      "فريقنا يرافقك من فكرة المناسبة حتى لحظة وداع آخر ضيف: تصميم يخصك وحدك، خامات فاخرة، وتنفيذ دقيق في الموعد.",
    counters: [
      { label: "حفل ناجح" },
      { label: "كوشة مصممة" },
      { label: "رضا العملاء" },
    ...
    items: [
      {
        n: "١",
        title: "نسمع حكايتك",
        text: "جلسة تعارف مجانية نفهم فيها ذوقك، عدد ضيوفك، وميزانيتك — بلا وعود فضفاضة.",
      },
      {
        n: "٢",
        title: "نرسم المشهد",
        text: "مخطط ألوان وخامات وإضاءة واضح، مع تصور مبدئي ترى به حفلتك قبل أن تقام.",
      },
      {
        n: "٣",
        title: "نجهز وننسق",
        text: "فريقنا يدخل القاعة قبلك بساعات: يركب، يرتب، ويفحص كل تفصيلة على checklist.",
      },
      {
        n: "٤",
        title: "تستمتع أنت",
        text: "تحضر كضيف شرف في مناسبتك، ونحن نتولى الكواليس حتى آخر ضيف.",
      },
    ],
  },
  musicians: {
    ...
    items: [
      ...
      },
      {
        img: "/piano.jpg",
        name: "بيانو",
        desc: "ألحان البيانو تعطي لحظاتك طابعا دافئ وأنيق",
      },
      {
        img: "/oud.jpg",
        name: "عود",
  ...
  afterlight: {
    ...
    titleA: "كل مناسبة تروى",
    titleB: "تبدأ من تفصيلة واحدة",
    kicker:
      "من أول وردة إلى آخر نجمة معلقة: نحن نهتم بالتفاصيل التي تروى بعدها الحكايات.",
  },
  railLabel: "الفصول",
  footer: {
    ...
    verifiedLabel: "موثق في منصة الأعمال",
    vatLabel: "الرقم الضريبي",
    vatNumber: "314951961700003",
  ...
  complaintsPage: {
    ...
    errFile: "الملف كبير جدا — الحد الأقصى 10 ميجابايت",
    submit: "أرسل",
    sending: "جاري الإرسال…",
    doneTitle: "تم الإرسال!",
    doneBody: "شكرا لمشاركتك — نأخذ كل ملاحظة على محمل الجد.",
  ...
  contactPage: {
    ...
    sending: "جاري الإرسال…",
    doneTitle: "تم الإرسال!",
    doneBody: "شكرا لتواصلك — سنرد عليك خلال 24 ساعة.",
    sendAnother: "إرسال رسالة أخرى",
  },
  meta: {
...
const en: typeof ar = {
  ...
  footer: {
    ...
    verifiedLabel: "Verified on the Business Platform",
    vatLabel: "VAT Number",
    vatNumber: "314951961700003",
